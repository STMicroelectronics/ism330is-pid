...
/**
  ...
  *
  */
int32_t __weak ism330is_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                 uint8_t *data,
                                 uint16_t len)
{
  int32_t ret = 0;
...
/**
  ...
  *
  */
int32_t __weak ism330is_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                  uint8_t *data,
                                  uint16_t len)
{
  int32_t ret = 0;
...
{
  ism330is_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = 0;
...
{
  ism330is_func_cfg_access_t func_cfg_access = {0};
  int32_t ret = 0;
...
{
  ism330is_drdy_pulsed_reg_t drdy_pulsed_reg = {0};
  int32_t ret = 0;
...
{
  ism330is_ctrl1_xl_t ctrl1_xl = {0};
  int32_t ret = 0;
                                   ...
                                   ism330is_gy_full_scale_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ctrl2_g.fs_125 = ((uint8_t)val >> 4) & 0x01U;
...
{
  ism330is_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = 0;
...
/**
  ...
  *
  */
int32_t ism330is_ui_i2c_mode_get(const stmdev_ctx_t *ctx, ism330is_ui_i2c_mode_t *val)
{
  ism330is_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = 0;
...
{
  ism330is_ctrl10_c_t ctrl10_c = {0};
  int32_t ret = 0;
  ...
  if (ret == 0)
  {
    ctrl10_c.timestamp_en = val & 0x01U;
...
int32_t ism330is_timestamp_raw_get(const stmdev_ctx_t *ctx, uint32_t *val)
{
  ...
  *val = (uint32_t)buff[3];
  *val = (*val << 8) | (uint32_t)buff[2];
  *val = (*val << 8) | (uint32_t)buff[1];
  *val = (*val << 8) | (uint32_t)buff[0];
...
/**
  ...
  *
  */
int32_t ism330is_all_sources_get(const stmdev_ctx_t *ctx, ism330is_all_sources_t *val)
{
  ism330is_status_reg_t status_reg = {0};
  ism330is_status_master_mainpage_t status_sh = {0};
  uint32_t status_ispu = 0;
  int32_t ret = 0;
...
{
  ism330is_int1_ctrl_t int1_ctrl = {0};
  ism330is_md1_cfg_t md1_cfg = {0};
  int32_t ret = 0;
...
{
  ism330is_int2_ctrl_t int2_ctrl = {0};
  ism330is_md2_cfg_t md2_cfg = {0};
  int32_t ret = 0;
...
{
  ism330is_master_config_t master_config = {0};
  int32_t ret = 0;
...
/**
  ...
  *
  */
int32_t ism330is_sh_master_interface_pull_up_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ism330is_master_config_t master_config = {0};
  int32_t ret = 0;
  ...
  master_config.shub_pu_en = val & 0x01U;
  ret = ism330is_write_reg(ctx, ISM330IS_MASTER_CONFIG, (uint8_t *)&master_config, 1);
...
int32_t ism330is_sh_reset_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  master_config.rst_master_regs = val & 0x01U;
  ret = ism330is_write_reg(ctx, ISM330IS_MASTER_CONFIG, (uint8_t *)&master_config, 1);
                              ...
                              ism330is_sh_cfg_write_t *val)
{
  ...
  reg.slave0_add = (uint8_t)(val->slv0_add >> 1) & 0x7FU;
  reg.rw_0 = 0U;
...
{
  ism330is_slv0_config_t slv0_config = {0};
  int32_t ret = 0;
...
{
  ism330is_slv0_add_t slv_add = {0};
  ism330is_slv0_config_t slv_config = {0};
  int32_t ret = 0;
  ...
  slv_add.slave0_add = (uint8_t)(val->slv_add >> 1) & 0x7FU;
  slv_add.rw_0 = 1U;
  ret = ism330is_write_reg(ctx, ISM330IS_SLV0_ADD + (uint8_t)(idx * 3U),
                           (uint8_t *)&slv_add, 1);
  if (ret != 0)
  {
    goto exit;
  ...
  ret = ism330is_write_reg(ctx, ISM330IS_SLV0_SUBADD + (uint8_t)(idx * 3U),
                           &(val->slv_subadd), 1);
  if (ret != 0)
  {
    goto exit;
  ...
  ret = ism330is_read_reg(ctx, ISM330IS_SLV0_CONFIG + (uint8_t)(idx * 3U),
  ...
  slv_config.slave0_numop = val->slv_len & 0x07U;
  ret = ism330is_write_reg(ctx, ISM330IS_SLV0_CONFIG + (uint8_t)(idx * 3U),
                           (uint8_t *)&slv_config, 1);
...
int32_t ism330is_ispu_reset_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    func_cfg_access.sw_reset_ispu = val & 0x01U;
    ret = ism330is_write_reg(ctx, ISM330IS_FUNC_CFG_ACCESS, (uint8_t *)&func_cfg_access, 1);
  }
                                ...
                                ism330is_ispu_clock_sel_t val)
{
  ...
  if (ret == 0)
  {
    ctrl10_c.ispu_clk_sel = (uint8_t)val & 0x01U;
    ret += ism330is_write_reg(ctx, ISM330IS_CTRL10_C, (uint8_t *)&ctrl10_c, 1);
  }
...
{
  ism330is_ispu_config_t ispu_config = {0};
  int32_t ret = 0;
  ...
  ispu_config.ispu_rst_n = (uint8_t)val & 0x01U;
  ispu_config.clk_dis = (uint8_t)val & 0x01U;
...
{
  ism330is_ispu_status_t ispu_boot_status = {0};
  int32_t ret = 0;
...
static int32_t ism330is_ispu_sel_memory_addr(const stmdev_ctx_t *ctx, uint16_t mem_addr)
{
...
{
  ism330is_ispu_mem_sel_t ispu_mem_sel = {0};
  ism330is_ispu_config_t ispu_cfg = {0};
  uint8_t clk_dis = 0U;
  int32_t ret = 0;
  uint16_t i = 0U;
  ...
  if (ret == 0)
  {
    ...
    ispu_mem_sel.read_mem_en = 0U;
    ispu_mem_sel.mem_sel = (uint8_t)mem_sel & 0x01U;
    ...
    ispu_cfg.clk_dis = clk_dis & 0x01U;
    ret += ism330is_write_reg(ctx, ISM330IS_ISPU_CONFIG, (uint8_t *)&ispu_cfg, 1);
    if (ret != 0)
    {
      goto exit;
...
{
  ism330is_ispu_if2s_flag_l_t flag_l = {0};
  ism330is_ispu_if2s_flag_h_t flag_h = {0};
  int32_t ret = 0;
...
int32_t ism330is_ispu_read_flags(const stmdev_ctx_t *ctx, uint16_t *data)
{
  ...
  if (ret == 0)
  {
    data[0] = (uint16_t)(buff[0] | ((uint16_t)buff[1] << 8));
  }
...
{
  ism330is_ispu_int1_ctrl0_t int1_ctrl0 = {0};
  ism330is_ispu_int1_ctrl1_t int1_ctrl1 = {0};
  ism330is_ispu_int1_ctrl2_t int1_ctrl2 = {0};
...
{
  ism330is_ispu_int2_ctrl0_t int2_ctrl0 = {0};
  ism330is_ispu_int2_ctrl1_t int2_ctrl1 = {0};
  ism330is_ispu_int2_ctrl2_t int2_ctrl2 = {0};
...
{
  ism330is_ispu_algo0_t algo0 = {0};
  ism330is_ispu_algo1_t algo1 = {0};
  ism330is_ispu_algo2_t algo2 = {0};
